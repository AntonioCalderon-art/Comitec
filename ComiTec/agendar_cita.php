            ...
            <div class="card shadow-lg p-3 mb-5 bg-body-tertiary rounded" style="margin: 20px; width: 800px; ">
                <div class="card-body ">
                    ...
                    <div style="margin: 30px;">
                        <button id="btnEnviarSolicitud" type="button" class="btn btn-primary"
                            style="padding-left: 250px; padding-right: 250px;">Enviar solicitud</button>
                    </div>
                </div>
            </div>
        </div>
...
>>>>>>> ce5916c8f2431145b55f61ccf7491803e560edfb:ComiTec/agendar_cita.html
